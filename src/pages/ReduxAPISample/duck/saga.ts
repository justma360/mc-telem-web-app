...
export function* handleFetchDatas(): Generator<
  CallEffect<AxiosResponse> | PutEffect<Action<string>>,
  void,
  unknown
> {
  try {
...
export function* watchFetchDatas(): Generator<ForkEffect<never>, void, unknown> {
